fn main() {
    ...
    for row in grid.iter() {
        for n in 0..row.len() - 3 {
            products.push(row[n..n + 4].iter().product());
        }
    }

    for row_index in 0..grid.len() - 3 {
        for n in 0..20 {
            products.push(
                grid[row_index][n]
                    * grid[row_index + 1][n]
        ...
        for n in 0..17 {
            products.push(
                grid[row_index][n]
                    * grid[row_index + 1][n + 1]
                    * grid[row_index + 2][n + 2]
                    * grid[row_index + 3][n + 3],
            );
            products.push(
                grid[row_index][n + 3]
                    * grid[row_index + 1][n + 2]
                    * grid[row_index + 2][n + 1]
                    * grid[row_index + 3][n],
            );
        }
    }
    ...
    println!("The largest product in the grid is: {}", max);
}
